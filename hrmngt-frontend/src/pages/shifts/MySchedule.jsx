...
const shiftOf = (shiftId) => shiftDefinitions.find((s) => s.id === shiftId);
        ...
        <div className="flex items-center justify-between gap-3">
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xs text-gray-500 mt-1">
              {def ? `${formatTime(def.startTime)} – ${formatTime(def.endTime)}` : 'Not assigned'}
            </p>
          </div>
                    ...
                    filtered.map((s) => {
                      ...
                      return (
                        <tr key={s.id} className="hover:bg-gray-50/50 transition-colors">
                          ...
                          <td className="px-6 py-4 text-sm text-gray-700 whitespace-nowrap">{def ? formatTime(def.startTime) : '—'}</td>
                          <td className="px-6 py-4 text-sm text-gray-700 whitespace-nowrap">{def ? formatTime(def.endTime) : '—'}</td>
                          <td className="px-6 py-4">
