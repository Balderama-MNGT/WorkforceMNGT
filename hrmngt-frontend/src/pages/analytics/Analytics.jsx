...
import {
  ...
  DollarSign, BarChart3, Download, ArrowUp, ArrowDown,
...
const kpis = [
  { label: 'Overall Attendance Rate', value: '92.5%', change: '+2.3%', up: true, icon: Percent, color: 'blue' },
  { label: 'Total Overtime Hours', value: '245h', change: '+12h', up: false, icon: Clock, color: 'amber' },
  { label: 'Employee Satisfaction', value: '4.2/5', change: '+0.3', up: true, icon: Award, color: 'purple' },
  { label: 'Payroll Discrepancy', value: '$27,800.00', sub: '10 discrepancies', change: '$2,500', up: false, icon: DollarSign, color: 'red' },
];
...
export default function Analytics() {
  ...
  const { attendanceTrend, departmentProductivity, leaveTrend, overtimeSummary, payrollDiscrepancy } = analyticsData;
          ...
          <Card key={k.label} className="overflow-hidden" hover>
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className={`flex items-center gap-1 mt-1 text-xs font-medium ${k.up ? 'text-emerald-600' : 'text-red-500'}`}>
